class_name MiscObjectLoader extends Node

@export var path:String
var objects:Dictionary
var objectsProba:Dictionary
...
func load_objects() -> void:
	...
	for file:String in dir.get_files():
		...
		objects.set(object.name, dir.get_current_dir() + "/" + file)
...
func get_object(name: StringName) -> Object:
	if (objects.has(name)): return load(objects.get(name))
